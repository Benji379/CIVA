...
public class moduloPasajero extends javax.swing.JPanel {

    ControladorPasajero controlador;

    public moduloPasajero() {
        initComponents();
        controlador = new ControladorPasajero(this);
    ...
    private void initComponents() {
        ...
        tablaPasajero = new MODELO.Tabla();
        ...
        comboGenero = new combo_suggestion.ComboBoxSuggestion();
        ...
        btnActualizar.setText("Exportar");
        ...
        tablaPasajero.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "N", "Dni", "Nombre", "Apellido", "Pasajero", "Fecha"
            }
        ) {
        ...
        comboGenero.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        jPanel12.add(comboGenero, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 40, 180, 30));
    ...
    public combo_suggestion.ComboBoxSuggestion comboGenero;
    ...
    public MODELO.Tabla tablaPasajero;
